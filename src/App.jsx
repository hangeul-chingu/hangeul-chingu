    ...
    const PRON_STEPS = [
      ...
      { id:"batchim_m", type:"learn", emoji:"🧱",
        ...
        items:[
          ...
          { char:"감사",  word:"감사",  meaning:{ko:"감사",  vi:"cảm ơn / cảm tạ",zh:"感谢",en:"gratitude/thanks",ja:"感謝",id:"terima kasih",ru:"благодарность",th:"ขอบคุณ",mn:"талархал",uz:"minnatdorchilik"} },
          ...
          { char:"처음",  word:"처음",  meaning:{ko:"처음",  vi:"lần đầu / ban đầu",zh:"第一次",en:"first time / beginning",ja:"初めて",id:"pertama kali",ru:"первый раз",th:"ครั้งแรก",mn:"анх удаа",uz:"birinchi marta"} },
          { char:"가슴",  word:"가슴",  meaning:{ko:"가슴",  vi:"ngực",zh:"胸",en:"chest/heart",ja:"胸",id:"dada",ru:"грудь",th:"หน้าอก",mn:"цээж",uz:"ko'krak"} },
        ],
