...
`}]
  ...
  if (step === "josa") {
    ...
    const VOCAB = [
      { word:"저",     hasBatchim:false, ex_topic:"저는 학생이에요.", ex_subj:"저가 먼저 갈게요.", ex_obj:"저를 도와주세요.", ex_and:"저와 함께 가요.", ex_or:null, ex_also:"저도 갈게요." },
      { word:"지수",   hasBatchim:false, ex_topic:"지수는 가수예요.", ex_subj:"지수가 노래해요.", ex_obj:"지수를 좋아해요.", ex_and:"지수와 함께 가요.", ex_or:null, ex_also:"지수도 좋아요." },
      { word:"그녀",   hasBatchim:false, ex_topic:"그녀는 선생님이에요.", ex_subj:"그녀가 와요.", ex_obj:"그녀를 만나요.", ex_and:"그녀와 이야기해요.", ex_or:null, ex_also:"그녀도 와요." },
      { word:"우리",   hasBatchim:false, ex_topic:"우리는 친구예요.", ex_subj:"우리가 가요.", ex_obj:"우리를 도와주세요.", ex_and:"우리와 함께 해요.", ex_or:null, ex_also:"우리도 가요." },
      { word:"여기",   hasBatchim:false, ex_topic:"여기는 학교예요.", ex_subj:"여기가 좋아요.", ex_obj:null, ex_and:null, ex_or:null, ex_also:"여기도 예뻐요." },
      { word:"사과",   hasBatchim:false, ex_topic:"사과는 맛있어요.", ex_subj:"사과가 있어요.", ex_obj:"사과를 먹어요.", ex_and:"사과와 바나나가 있어요.", ex_or:"사과나 바나나를 드세요.", ex_also:"사과도 맛있어요." },
      { word:"커피",   hasBatchim:false, ex_topic:"커피는 뜨거워요.", ex_subj:"커피가 있어요.", ex_obj:"커피를 마셔요.", ex_and:"커피와 빵이 있어요.", ex_or:"커피나 주스를 마셔요.", ex_also:"커피도 있어요." },
      { word:"꽃",     hasBatchim:false, ex_topic:"꽃은 예뻐요.", ex_subj:"꽃이 있어요.", ex_obj:"꽃을 사요.", ex_and:null, ex_or:null, ex_also:"꽃도 좋아요." },
      { word:"한국",   hasBatchim:false, ex_topic:"한국은 아름다워요.", ex_subj:"한국이 좋아요.", ex_obj:null, ex_and:null, ex_or:null, ex_also:"한국도 가요." },
      { word:"정국",   hasBatchim:true,  ex_topic:"정국은 가수예요.", ex_subj:"정국이 노래해요.", ex_obj:"정국을 좋아해요.", ex_and:"정국과 함께 가요.", ex_or:null, ex_also:"정국도 좋아요." },
      { word:"당신",   hasBatchim:true,  ex_topic:"당신은 학생이에요.", ex_subj:"당신이 맞아요.", ex_obj:"당신을 만나요.", ex_and:"당신과 이야기해요.", ex_or:null, ex_also:"당신도 가요." },
      { word:"그",     hasBatchim:false, ex_topic:"그는 선생님이에요.", ex_subj:"그가 와요.", ex_obj:"그를 만나요.", ex_and:"그와 공부해요.", ex_or:null, ex_also:"그도 와요." },
      { word:"그들",   hasBatchim:true,  ex_topic:"그들은 학생이에요.", ex_subj:"그들이 가요.", ex_obj:"그들을 만나요.", ex_and:"그들과 공부해요.", ex_or:null, ex_also:"그들도 가요." },
      { word:"저것",   hasBatchim:true,  ex_topic:"저것은 책이에요.", ex_subj:"저것이 예뻐요.", ex_obj:"저것을 주세요.", ex_and:null, ex_or:"이것이나 저것을 고르세요.", ex_also:"저것도 있어요." },
      { word:"빵",     hasBatchim:true,  ex_topic:"빵은 맛있어요.", ex_subj:"빵이 있어요.", ex_obj:"빵을 먹어요.", ex_and:"빵과 우유가 있어요.", ex_or:"빵이나 밥을 먹어요.", ex_also:"빵도 맛있어요." },
      { word:"학생",   hasBatchim:true,  ex_topic:"학생은 바빠요.", ex_subj:"학생이 공부해요.", ex_obj:"학생을 도와요.", ex_and:"학생과 선생님이에요.", ex_or:null, ex_also:"학생도 쉬어요." },
      { word:"선생님", hasBatchim:true,  ex_topic:"선생님은 바빠요.", ex_subj:"선생님이 와요.", ex_obj:"선생님을 만나요.", ex_and:"선생님과 공부해요.", ex_or:null, ex_also:"선생님도 가요." },
      { word:"책",     hasBatchim:true,  ex_topic:"책은 재미있어요.", ex_subj:"책이 있어요.", ex_obj:"책을 읽어요.", ex_and:"책과 연필이 있어요.", ex_or:"책이나 연필을 사요.", ex_also:"책도 있어요." },
    ];
    ...
    const QPRON = [
      { word:"누구", meaning:vi?"ai":en?"who":"사람",
        rows:[
          ...
          { role:vi?"Trạng ngữ":en?"Adverbial":"부사어",   form:"누구와",   ex:"당신은 누구와 공부해요?" },
      ...
      { word:"언제", meaning:vi?"khi nào":en?"when":"시간",
        rows:[
          { role:vi?"Chủ ngữ":en?"Subject":"주어",        form:"(언제가)", ex:"당신의 생일은 언제입니까?" },
      ...
      { word:"어디", meaning:vi?"ở đâu":en?"where":"장소",
        rows:[
          { role:vi?"Chủ ngữ":en?"Subject":"주어",        form:"어디가",   ex:"어디가 제일 좋아요?" },
          { role:vi?"Trạng ngữ":en?"Adverbial":"부사어(장소)", form:"어디에/어디에서", ex:"당신은 어디에서 공부해요?" },
      ...
      { word:"무엇(뭐)", meaning:vi?"cái gì":en?"what":"사물",
        rows:[
          ...
          { role:vi?"Tân ngữ":en?"Object":"목적어",        form:"무엇을/뭐를", ex:"당신은 무엇을 공부해요?" },
          { role:vi?"Vị ngữ":en?"Predicate":"서술어",      form:"무엇입니까?/뭐예요?", ex:"이것은 무엇입니까?" },
        ]
      },
      { word:"왜", meaning:vi?"tại sao":en?"why":"이유",
        rows:[
          { role:vi?"Trạng ngữ":en?"Adverbial":"부사어(이유)", form:"왜",    ex:"당신은 왜 한국어를 공부해요?" },
          { role:"",                                            form:"",      ex:"그는 왜 학교에 갔습니까?" },
        ]
      },
    ];
          ...
          {vocab && (
            <div style={{background:"white", borderRadius:16, border:"2px solid #FFE0B2", overflow:"hidden", marginBottom:14}}>
              ...
              {COLS.map(col => {
                ...
                const revealed = isRevealed(vocab.word, col.key);
                return (
                  <div key={col.key} style={{borderTop:"1px solid #FFF3E0"}}>
                    <button onClick={()=>{ toggleReveal(vocab.word, col.key); if(!revealed && ex) setTimeout(()=>speak(ex),200); }}
                      style={{width:"100%", background:"none", border:"none", cursor:"pointer", padding:"10px 14px", textAlign:"left"}}>
                      <div style={{display:"flex", alignItems:"center", gap:8}}>
                        ...
                        {revealed ? (
                          <>
                            {/* 공개된 조사 형태 */}
                            <span style={{fontSize:18, fontWeight:900, color:"#E65100", minWidth:90}}>
                              {form}
                              <span style={{fontSize:11, color:"#FF9800", fontWeight:700}}> (-{josa})</span>
                            </span>
                            {/* 예문 */}
                            {ex && <span style={{fontSize:12, color:"#555", flex:1, lineHeight:1.4}}>{ex}</span>}
                            {/* TTS */}
                            {ex && (
                              <span onClick={e=>{e.stopPropagation();speak(ex);}}
                                style={{background:"#FF9800", borderRadius:50, width:26, height:26, fontSize:12, display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, cursor:"pointer"}}>
                                🔊
                              </span>
                            )}
                          </>
                          ...
                          /* 빈칸 */
                          <span style={{fontSize:16, fontWeight:900, color:"#ccc", border:"2px dashed #FFE0B2", borderRadius:8, padding:"4px 16px", minWidth:90, display:"inline-block", textAlign:"center"}}>
                            ?
                          </span>
                        )}
                      </div>
            ...
            {QPRON.map((qp, qi) => (
              <div key={qi} style={{borderTop: qi===0?"none":"1px solid #FFF3E0"}}>
                ...
                {qp.rows.filter(r=>r.form).map((row, ri) => (
                  <div key={ri} style={{padding:"6px 14px 6px 24px", borderTop:"1px solid #FFF8F0", display:"flex", alignItems:"flex-start", gap:8}}>
                    <span style={{fontSize:10, color:"#aaa", minWidth:64, paddingTop:2, flexShrink:0}}>{row.role}</span>
                    <div style={{flex:1}}>
                      <span style={{fontSize:14, fontWeight:800, color:"#FF9800"}}>{row.form}</span>
                      <div style={{fontSize:12, color:"#555", marginTop:2, lineHeight:1.4}}>{row.ex}</div>
                    </div>
                    <button onClick={()=>speak(row.ex)}
                      style={{background:"#FF9800", border:"none", borderRadius:50, width:24, height:24, fontSize:11, cursor:"pointer", flexShrink:0, marginTop:2}}>🔊</button>
                  </div>
                ))}
              </div>
            ))}
...
힌트는 반드시 '받침 없음 → ...' 또는 '받침 있음 → ...' 형식으로 작성`}]
  ...
  if (step === "test2") {
    ...
    const TEST2_QUESTIONS = [
      ...
      // ── 2B단원 10문제 (위치 표현)
      { id:"t2_21", q:"책상 위에 책이 ___.",         answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 위치 표현 + ___어요" },
      { id:"t2_22", q:"화장실이 어디에 ___?",         answer:"있어요",  answers:["있어요","있어요?","있어요."],  hint:"💡 장소 물을 때 + ___어요" },
      { id:"t2_23", q:"가방 안에 지갑이 ___.",        answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 안(inside) → 뭐가 있어요?" },
      { id:"t2_24", q:"은행 옆에 편의점이 ___.",      answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 옆(beside) → 뭐가 있어요?" },
      { id:"t2_25", q:"냉장고 앞에 고양이가 ___.",    answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 앞(in front) → 뭐가 있어요?" },
      { id:"t2_26", q:"의자 아래에 가방이 ___.",      answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 아래(below) → 뭐가 있어요?" },
      { id:"t2_27", q:"학교 앞에 카페가 ___.",        answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 앞(정면) → 뭐가 있어요?" },
      { id:"t2_28", q:"마트가 어디에 ___?",           answer:"있어요",  answers:["있어요","있어요?","있어요."],  hint:"💡 장소 물을 때 + ___어요" },
      { id:"t2_29", q:"방 안에 침대가 ___.",          answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 안(속) → 뭐가 있어요?" },
      { id:"t2_30", q:"소파 위에 고양이가 ___.",      answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 위(above) → 뭐가 있어요?" },
    ];
  ...
  if (step === "test4") {
    ...
    const TEST4_QUESTIONS = [
      ...
      // ── 2단원B 위치표현 (보완 6문항) ──
      { id:"t4_41", q:"책상 위에 책이 ___.",           answer:"있어요",  answers:["있어요","있어요."],       hint:"💡 위(above) → 뭐가 있어요?" },
      { id:"t4_42", q:"가방 안에 지갑이 ___.",         answer:"있어요",  answers:["있어요","있어요."],       hint:"💡 안(inside) → 뭐가 있어요?" },
      { id:"t4_43", q:"은행 옆에 편의점이 ___.",       answer:"있어요",  answers:["있어요","있어요."],       hint:"💡 옆(beside) → 뭐가 있어요?" },
      { id:"t4_44", q:"냉장고 앞에 고양이가 ___.",     answer:"있어요",  answers:["있어요","있어요."],       hint:"💡 앞(in front) → 뭐가 있어요?" },
      { id:"t4_45", q:"화장실이 어디에 ___?",          answer:"있어요",  answers:["있어요","있어요?"],       hint:"💡 장소 물을 때 + ___어요" },
      { id:"t4_46", q:"의자 아래에 가방이 ___.",       answer:"있어요",  answers:["있어요","있어요."],       hint:"💡 아래(below) → 뭐가 있어요?" },
      ...
      { id:"t4_50", q:"이 식당이 ___.",                answer:"싸요",    answers:["싸요","싸요."],           hint:"💡 싸다 (가격이 낮음)" },
    ];
  ...
  if (step === "test6") {
    ...
    const TEST6_QUESTIONS = [
      // ── 1단원 복습 5문제
      { id:"t6_1",  q:"저는 의사___.",            answer:"예요",    answers:["예요","예요."],      hint:"💡 받침 없음 → __요" },
      { id:"t6_2",  q:"오늘은 금요일___.",          answer:"이에요",  answers:["이에요","이에요."],  hint:"💡 받침 있음 → 이__요" },
      { id:"t6_3",  q:"이분은 원장님___.",           answer:"이세요",  answers:["이세요","이세요."],  hint:"💡 높임말 (어른께 쓰는 말)" },
      { id:"t6_4",  q:"저는 베트남 사람___.",        answer:"이에요",  answers:["이에요","이에요."],  hint:"💡 받침 있음" },
      { id:"t6_5",  q:"여기는 도서관___.",           answer:"이에요",  answers:["이에요","이에요."],  hint:"💡 받침 있음" },
      // ── 2A단원 복습 5문제
      { id:"t6_6",  q:"오늘 시간이 ___.",           answer:"없어요",  answers:["없어요","없어요."],  hint:"💡 없다" },
      { id:"t6_7",  q:"교실에 학생이 ___.",          answer:"많아요",  answers:["많아요","많아요."],  hint:"💡 많다" },
      { id:"t6_8",  q:"냉장고에 음식이 ___.",        answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 있다" },
      { id:"t6_9",  q:"오늘 버스에 사람이 ___.",     answer:"적어요",  answers:["적어요","적어요."],  hint:"💡 적다" },
      { id:"t6_10", q:"지갑에 돈이 ___.",           answer:"없어요",  answers:["없어요","없어요."],  hint:"💡 없다" },
      // ── 2B단원 복습 5문제
      { id:"t6_11", q:"화장실이 어디에 ___?",        answer:"있어요",  answers:["있어요","있어요?"],  hint:"💡 위치 표현 + ___어요" },
      { id:"t6_12", q:"가방 안에 지갑이 ___.",       answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 안(inside) → 뭐가 있어요?" },
      { id:"t6_13", q:"은행 옆에 편의점이 ___.",     answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 옆(beside) → 뭐가 있어요?" },
      { id:"t6_14", q:"책상 위에 책이 ___.",         answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 위(above) → 뭐가 있어요?" },
      { id:"t6_15", q:"냉장고 앞에 고양이가 ___.",   answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 앞(in front) → 뭐가 있어요?" },
      // ── 3A단원 복습 5문제
  ...
  if (step === "test7") {
    ...
    const TEST7_QUESTIONS = [
      ...
      { id:"t7_13", q:"책상 위에 책이 ___.",           answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 위치 표현 + ___어요" },
      { id:"t7_14", q:"가방 안에 지갑이 ___.",         answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 안(inside) → 뭐가 있어요?" },
      { id:"t7_15", q:"은행 옆에 편의점이 ___.",       answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 옆(beside) → 뭐가 있어요?" },
  ...
  if (step === "test8") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const TEST8_Q = [
      { id:"t8_1",  q:"같이 밥 먹___. (함께 하자·격식)",    answer:"읍시다",  answers:["읍시다","읍시다."],   hint:"💡 먹다 → 받침+읍시다" },
      { id:"t8_2",  q:"빨리 ___. (가자)",                    answer:"갑시다",  answers:["갑시다","갑시다."],   hint:"💡 가다 → ㅂ시다" },
      { id:"t8_3",  q:"영화 볼___? (제안·의향)",              answer:"까요",    answers:["까요","까요?"],       hint:"💡 ~ㄹ까요?" },
      { id:"t8_4",  q:"같이 공부할___? (권유)",               answer:"래요",    answers:["래요","래요?"],       hint:"💡 ~ㄹ래요?" },
      { id:"t8_5",  q:"저는 학생___. (받침 있음)",            answer:"이에요",  answers:["이에요","이에요."],   hint:"💡 이에요/예요" },
      { id:"t8_6",  q:"시간이 ___. (없음)",                   answer:"없어요",  answers:["없어요","없어요."],   hint:"💡 없다" },
      { id:"t8_7",  q:"이 가방이 ___. (크다→으탈락)",        answer:"커요",    answers:["커요","커요."],        hint:"💡 크다 → 커요" },
      { id:"t8_8",  q:"학교에 ___ 공부해요. (이유)",         answer:"가서",    answers:["가서"],               hint:"💡 가다+아/어서" },
      { id:"t8_9",  q:"지금 밥을 먹고 ___. (진행)",          answer:"있어요",  answers:["있어요","있어요."],   hint:"💡 -고 있다" },
      { id:"t8_10", q:"뭐 마실___? (의향)",                   answer:"래요",    answers:["래요","래요?"],       hint:"💡 ~ㄹ래요?" },
    ];
    function gradeTest8() {
      let ok=0;
    ...
    return (
      <div style={{minHeight:"100vh", background:"linear-gradient(150deg,#E3F2FD,#BBDEFB)", display:"flex", flexDirection:"column", alignItems:"center", padding:"24px 16px", fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>
        ...
        <div style={{width:"100%", maxWidth:400}}>
          ...
          <div style={{fontSize:12, color:"#aaa", marginBottom:16}}>범위: 이다·있다·형용사·의문대명사·세요·연결·진행·청유 (10문제)</div>
          {TEST8_Q.map((q,i) => (
            <div key={q.id} style={{background:"white", borderRadius:12, padding:"12px 14px", marginBottom:8}}>
              <div style={{fontSize:13, fontWeight:700, color:"#333", marginBottom:6}}>{i+1}. {q.q}</div>
  ...
  if (step === "unit9") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const UNIT9_CARDS = [
      { front:"저는 한국어를 말할 ___ ___. (가능)", blank:"수 있어요", full:"저는 한국어를 말할 수 있어요.", hint:"💡 동사+ㄹ 수 있다 = 할 수 있음" },
      { front:"저는 수영을 할 ___ ___. (불가능)", blank:"수 없어요", full:"저는 수영을 할 수 없어요.", hint:"💡 동사+ㄹ 수 없다 = 못함" },
      { front:"이 음식을 먹을 ___ ___? (가능 여부)", blank:"수 있어요", full:"이 음식을 먹을 수 있어요?", hint:"💡 먹다 → 먹을 수 있다" },
      { front:"저는 피아노를 칠 ___ ___. (가능)", blank:"수 있어요", full:"저는 피아노를 칠 수 있어요.", hint:"💡 치다 → 칠 수 있다" },
      { front:"오늘 만날 ___ ___? (가능 여부)", blank:"수 있어요", full:"오늘 만날 수 있어요?", hint:"💡 만나다 → 만날 수 있다" },
      { front:"저는 운전을 할 ___ ___. (불가능)", blank:"수 없어요", full:"저는 운전을 할 수 없어요.", hint:"💡 할 수 없다 = 못함" },
    ];
  ...
  if (step === "test9") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const TEST9_Q = [
      { id:"t9_1",  q:"저는 한국어를 말할 ___ ___. (가능)",    answer:"수 있어요",  answers:["수 있어요","수 있어요."],  hint:"💡 -(으)ㄹ 수 있다" },
      { id:"t9_2",  q:"저는 수영을 할 ___ ___. (불가능)",       answer:"수 없어요",  answers:["수 없어요","수 없어요."],  hint:"💡 -(으)ㄹ 수 없다" },
      { id:"t9_3",  q:"오늘 만날 ___ ___? (가능 여부)",         answer:"수 있어요",  answers:["수 있어요","수 있어요?"],  hint:"💡 만나다 → 만날 수 있다" },
      { id:"t9_4",  q:"같이 밥 먹___. (청유·격식)",             answer:"읍시다",     answers:["읍시다","읍시다."],        hint:"💡 먹다+읍시다" },
      { id:"t9_5",  q:"영화 볼___? (제안)",                     answer:"까요",       answers:["까요","까요?"],            hint:"💡 ~ㄹ까요?" },
      { id:"t9_6",  q:"지금 밥을 먹고 ___. (진행)",             answer:"있어요",     answers:["있어요","있어요."],        hint:"💡 -고 있다" },
      { id:"t9_7",  q:"날씨가 ___. (좋다)",                     answer:"좋아요",     answers:["좋아요","좋아요."],        hint:"💡 좋다 → 좋아요" },
      { id:"t9_8",  q:"학교에 ___ 공부해요. (이유)",            answer:"가서",       answers:["가서"],                    hint:"💡 가다+아/어서" },
      { id:"t9_9",  q:"오늘 일이 ___. (많다)",                  answer:"많아요",     answers:["많아요","많아요."],        hint:"💡 많다 → 많아요" },
      { id:"t9_10", q:"저는 피아노를 칠 ___ ___. (가능)",       answer:"수 있어요",  answers:["수 있어요","수 있어요."],  hint:"💡 치다 → 칠 수 있다" },
    ];
    function gradeTest9() {
      let ok=0;
  ...
  if (step === "unit10") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const UNIT10_CARDS = [
      { front:"저는 한국에 가고 ___. (희망)", blank:"싶어요", full:"저는 한국에 가고 싶어요.", hint:"💡 동사+고 싶다 = 원함" },
      { front:"저는 한국어를 잘하고 ___. (희망)", blank:"싶어요", full:"저는 한국어를 잘하고 싶어요.", hint:"💡 잘하다+고 싶다" },
      { front:"뭘 먹고 ___? (의향 물음)", blank:"싶어요", full:"뭘 먹고 싶어요?", hint:"💡 먹다+고 싶다 → 질문" },
      { front:"저는 친구를 만나고 ___. (희망)", blank:"싶어요", full:"저는 친구를 만나고 싶어요.", hint:"💡 만나다+고 싶다" },
      { front:"저는 쉬고 ___. (희망)", blank:"싶어요", full:"저는 쉬고 싶어요.", hint:"💡 쉬다+고 싶다" },
      { front:"무슨 영화를 보고 ___? (의향)", blank:"싶어요", full:"무슨 영화를 보고 싶어요?", hint:"💡 보다+고 싶다" },
    ];
  ...
  if (step === "test10") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const TEST10_Q = [
      { id:"t10_1",  q:"저는 한국에 가고 ___. (희망)",          answer:"싶어요",    answers:["싶어요","싶어요."],       hint:"💡 -고 싶다" },
      { id:"t10_2",  q:"뭘 먹고 ___? (의향)",                   answer:"싶어요",    answers:["싶어요","싶어요?"],       hint:"💡 먹다+고 싶다" },
      { id:"t10_3",  q:"저는 수영을 할 ___ ___. (불가능)",      answer:"수 없어요", answers:["수 없어요","수 없어요."], hint:"💡 -(으)ㄹ 수 없다" },
      { id:"t10_4",  q:"같이 공부할___? (권유)",                 answer:"래요",      answers:["래요","래요?"],           hint:"💡 ~ㄹ래요?" },
      { id:"t10_5",  q:"저는 한국어를 잘하고 ___. (희망)",      answer:"싶어요",    answers:["싶어요","싶어요."],       hint:"💡 -고 싶다" },
      { id:"t10_6",  q:"이 음식이 ___. (맵다→ㅂ불규칙)",        answer:"매워요",    answers:["매워요","매워요."],       hint:"💡 맵다 → 매워요" },
      { id:"t10_7",  q:"저는 운전을 할 ___ ___. (불가능)",      answer:"수 없어요", answers:["수 없어요","수 없어요."], hint:"💡 -(으)ㄹ 수 없다" },
      { id:"t10_8",  q:"빨리 ___. (가자·격식)",                  answer:"갑시다",    answers:["갑시다","갑시다."],       hint:"💡 가다+ㅂ시다" },
      { id:"t10_9",  q:"지금 밥을 먹고 ___. (진행)",            answer:"있어요",    answers:["있어요","있어요."],       hint:"💡 -고 있다" },
      { id:"t10_10", q:"저는 쉬고 ___. (희망)",                  answer:"싶어요",    answers:["싶어요","싶어요."],       hint:"💡 쉬다+고 싶다" },
    ];
  ...
  if (step === "unit11") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const UNIT11_CARDS = [
      { front:"날씨가 좋___으면 좋겠어요. (희망)", blank:"았", full:"날씨가 좋았으면 좋겠어요.", hint:"💡 좋다(아계열)+았으면 좋겠다" },
      { front:"빨리 방학이 ___으면 좋겠어요. (희망)", blank:"됐", full:"빨리 방학이 됐으면 좋겠어요.", hint:"💡 되다 → 됐으면 좋겠다" },
      { front:"돈이 많___으면 좋겠어요. (희망)", blank:"았", full:"돈이 많았으면 좋겠어요.", hint:"💡 많다+았으면 좋겠다" },
      { front:"건강___으면 좋겠어요. (희망·건강)", blank:"했", full:"건강했으면 좋겠어요.", hint:"💡 건강하다 → 했으면 좋겠다" },
      { front:"걱정이 없___으면 좋겠어요. (희망)", blank:"었", full:"걱정이 없었으면 좋겠어요.", hint:"💡 없다(어계열)+었으면 좋겠다" },
      { front:"부모님이 오래 사셨___으면 좋겠어요.", blank:"으면 좋겠어요", full:"부모님이 오래 사셨으면 좋겠어요.", hint:"💡 -셨으면 좋겠다 (높임+희망)" },
    ];
  ...
  if (step === "test11") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const TEST11_Q = [
      { id:"t11_1",  q:"날씨가 좋___으면 좋겠어요.",             answer:"았",        answers:["았"],                     hint:"💡 좋다(아계열)" },
      { id:"t11_2",  q:"돈이 많___으면 좋겠어요.",               answer:"았",        answers:["았"],                     hint:"💡 많다(아계열)" },
      { id:"t11_3",  q:"걱정이 없___으면 좋겠어요.",             answer:"었",        answers:["었"],                     hint:"💡 없다(어계열)" },
      { id:"t11_4",  q:"저는 한국어를 잘하고 ___. (희망)",      answer:"싶어요",    answers:["싶어요","싶어요."],        hint:"💡 -고 싶다" },
      { id:"t11_5",  q:"저는 수영을 할 ___ ___. (불가능)",      answer:"수 없어요", answers:["수 없어요","수 없어요."],  hint:"💡 -(으)ㄹ 수 없다" },
      { id:"t11_6",  q:"같이 밥 먹___. (청유·격식)",             answer:"읍시다",    answers:["읍시다","읍시다."],        hint:"💡 먹다+읍시다" },
      { id:"t11_7",  q:"이 음식이 ___. (맵다)",                  answer:"매워요",    answers:["매워요","매워요."],        hint:"💡 맵다 → ㅂ불규칙" },
      { id:"t11_8",  q:"지금 공부하고 ___. (진행)",              answer:"있어요",    answers:["있어요","있어요."],        hint:"💡 -고 있다" },
      { id:"t11_9",  q:"영화 볼___? (제안)",                     answer:"까요",      answers:["까요","까요?"],            hint:"💡 ~ㄹ까요?" },
      { id:"t11_10", q:"건강___으면 좋겠어요.",                   answer:"했",        answers:["했"],                     hint:"💡 건강하다 → 했으면" },
    ];
  ...
  if (step === "unit12") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const UNIT12_CARDS = [
      { front:"저는 오늘 밥을 ___ 먹어요. (의지 부정)", blank:"안", full:"저는 오늘 밥을 안 먹어요.", hint:"💡 안 + 동사 = 의지로 안 함" },
      { front:"저는 수영을 ___ 해요. (능력 부정)", blank:"못", full:"저는 수영을 못 해요.", hint:"💡 못 + 동사 = 능력이 없어서" },
      { front:"저는 고기를 먹지 ___. (의지 부정·정중)", blank:"않아요", full:"저는 고기를 먹지 않아요.", hint:"💡 -지 않다 = 안 하다(정중)" },
      { front:"저는 운전을 하지 ___. (능력 부정·정중)", blank:"못해요", full:"저는 운전을 하지 못해요.", hint:"💡 -지 못하다 = 못 하다(정중)" },
  ...
  if (step === "test12") {
    const vi = lang?.code === "vi"; const en = lang?.code === "en";
    const TEST12_Q = [
      { id:"t12_1",  q:"저는 오늘 밥을 ___ 먹어요. (의지 부정)", answer:"안",       answers:["안"],                     hint:"💡 안 + 동사" },
      { id:"t12_2",  q:"저는 수영을 ___ 해요. (능력 부정)",       answer:"못",       answers:["못"],                     hint:"💡 못 + 동사" },
      { id:"t12_3",  q:"고기를 먹지 ___. (정중 부정)",            answer:"않아요",   answers:["않아요","않아요."],        hint:"💡 -지 않다" },
      { id:"t12_4",  q:"여기서 사진 찍지 ___. (금지)",            answer:"마세요",   answers:["마세요","마세요."],        hint:"💡 -지 마세요" },
      { id:"t12_5",  q:"날씨가 좋___으면 좋겠어요. (희망)",       answer:"았",       answers:["았"],                     hint:"💡 좋다→아계열" },
      { id:"t12_6",  q:"저는 한국에 가고 ___. (희망)",            answer:"싶어요",   answers:["싶어요","싶어요."],        hint:"💡 -고 싶다" },
      { id:"t12_7",  q:"영화 볼___? (제안)",                      answer:"까요",     answers:["까요","까요?"],            hint:"💡 ~ㄹ까요?" },
      { id:"t12_8",  q:"저는 한국어를 말할 ___ ___. (가능)",      answer:"수 있어요",answers:["수 있어요","수 있어요."],  hint:"💡 -(으)ㄹ 수 있다" },
      { id:"t12_9",  q:"교실에서 떠들지 ___. (함께 금지)",        answer:"맙시다",   answers:["맙시다","맙시다."],        hint:"💡 -지 맙시다" },
      { id:"t12_10", q:"지금 공부하고 ___. (진행)",                answer:"있어요",   answers:["있어요","있어요."],        hint:"💡 -고 있다" },
    ];
