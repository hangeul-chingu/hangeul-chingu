...
힌트는 반드시 '받침 없음 → ...' 또는 '받침 있음 → ...' 형식으로 작성`}]
  ...
  if (step === "test8") {
    ...
    const TEST8_Q = [
      // ── 1단원 복습 2문제 ──
      { id:"t8_1",  q:"저는 의사___. (직업)",                 answer:"입니다",    answers:["입니다","입니다."],     hint:"💡 받침 없음 → 입니다" },
      { id:"t8_2",  q:"여기는 학교가 ___. (부정)",            answer:"아닙니다",  answers:["아닙니다","아닙니다."], hint:"💡 아니다 → 아닙니다" },
      // ── 2단원 복습 2문제 ──
      { id:"t8_3",  q:"교실에 학생이 ___. (많음)",            answer:"많습니다",  answers:["많습니다","많습니다."], hint:"💡 많다 → 많습니다" },
      { id:"t8_4",  q:"가방 안에 지갑이 ___. (위치)",         answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 있다 → 있습니다" },
      // ── 3~4단원 복습 2문제 ──
      { id:"t8_5",  q:"오늘 날씨가 ___. (춥다→ㅂ불규칙)",    answer:"춥습니다",  answers:["춥습니다","춥습니다."], hint:"💡 춥다 → ㅂ불규칙 → 춥습니다" },
      { id:"t8_6",  q:"___ 갑니까? (장소 질문)",              answer:"어디",      answers:["어디"],                 hint:"💡 장소 의문대명사" },
      // ── 5~7단원 복습 2문제 ──
      { id:"t8_7",  q:"___ (앉다 → 부드러운 명령)",           answer:"앉으세요",  answers:["앉으세요","앉으세요."], hint:"💡 앉다 → 으세요" },
      { id:"t8_8",  q:"지금 밥을 먹고 ___. (진행)",           answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 -고 있다 → 있습니다" },
      // ── 8단원 복습 2문제 ──
      { id:"t8_9",  q:"같이 밥 먹___. (함께 하자·격식)",      answer:"읍시다",    answers:["읍시다","읍시다."],     hint:"💡 먹다 → 받침+읍시다" },
      { id:"t8_10", q:"영화 볼___? (제안·의향)",               answer:"까요",      answers:["까요","까요?"],         hint:"💡 -(으)ㄹ까요?" },
    ];
    function gradeTest8() {
      let ok=0;
