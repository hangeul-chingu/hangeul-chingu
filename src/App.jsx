...
출력: JSON만 {"questions":[{"id":1,"sentence":"저___ 학생이에요.","answer":"는","hint":"주제 조사"}]}`}]
  ...
  if (step === "test6") {
    ...
    const TEST6_QUESTIONS = [
      ...
      { id:"t6_3",  q:"이분은 원장님___.",           answer:"이세요",  answers:["이세요","이세요."],  hint:"💡 높임 → 이세요" },
      ...
      // ── 2B단원 복습 5문제
      { id:"t6_11", q:"화장실이 어디에 ___?",        answer:"있어요",  answers:["있어요","있어요?"],  hint:"💡 위치 + 있어요" },
      { id:"t6_12", q:"가방 안에 지갑이 ___.",       answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 안 = inside" },
      { id:"t6_13", q:"은행 옆에 편의점이 ___.",     answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 옆 = beside" },
      { id:"t6_14", q:"책상 위에 책이 ___.",         answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 위 = above" },
      { id:"t6_15", q:"냉장고 앞에 고양이가 ___.",   answer:"있어요",  answers:["있어요","있어요."],  hint:"💡 앞 = in front" },
      // ── 3A단원 복습 5문제
      ...
      { id:"t6_30", q:"___ 친구예요? (주어)",       answer:"누가",  answers:["누가"],               hint:"💡 누구+가→누가" },
      // ── 5단원 복습 5문제
      ...
      { id:"t6_38", q:"한국어가 재미있어요. ___ 어려워요.",       answer:"하지만",  answers:["하지만","그러나"],  hint:"💡 강한 반대 → 하지만/그러나" },
      ...
      { id:"t6_41", q:"저는 한국 음식을 좋아해요. ___ 매운 건 못 먹어요.", answer:"하지만", answers:["하지만","그러나"], hint:"💡 강한 반대 → 하지만/그러나" },
      // ── 6B단원 10문제 (연결어미)
      ...
      { id:"t6_45", q:"한국어가 재미있___ 어려워요.",    answer:"지만",answers:["지만"],hint:"💡 반대(한 문장) → -지만" },
      { id:"t6_46", q:"값이 비싸___ 좋아요.",           answer:"지만",answers:["지만"],hint:"💡 반대(한 문장) → -지만" },
      { id:"t6_47", q:"배가 고파___ 밥을 먹어요.",      answer:"서",  answers:["서"],  hint:"💡 이유 → -아/어서" },
      { id:"t6_48", q:"날씨가 좋___ 공원에 가요.",      answer:"아서",answers:["아서","서"],hint:"💡 이유 → -아서" },
      ...
      { id:"t6_51", q:"음식이 맛있___ 많이 먹었어요.",  answer:"어서",answers:["어서","서"],hint:"💡 이유 → -어서" },
      { id:"t6_52", q:"배가 불___ 디저트는 안 먹어요.", answer:"지만",answers:["지만"],hint:"💡 반대(한 문장) → -지만" },
      ...
      { id:"t6_56", q:"한국어가 재미있어요. ___ 어려워요.",      answer:"하지만",  answers:["하지만","그러나","그렇지만"], hint:"💡 강한 반대 → 하지만/그러나/그렇지만" },
      // ── 6C단원 6문제 (-(으)면·-(으)니까·-는데)
      { id:"t6_57", q:"시간이 있___ 와요.",           answer:"으면",   answers:["으면"],        hint:"💡 받침 있음 → -으면 (조건)" },
      { id:"t6_58", q:"한국에 가___ 한국어를 배워요.", answer:"면",     answers:["면"],          hint:"💡 받침 없음 → -면 (조건)" },
      { id:"t6_59", q:"날씨가 좋___ 공원에 가요.",    answer:"으면",   answers:["으면"],        hint:"💡 받침 있음 → -으면" },
  ...
  if (step === "test7") {
    ...
    const TEST7_QUESTIONS = [
      // ── 1단원: 이에요/예요/아니에요 (8문항) ──
      { id:"t7_1",  q:"저는 회사원___.",              answer:"이에요",     answers:["이에요","이에요."],      hint:"💡 받침 있음 → 이에요" },
      { id:"t7_2",  q:"여기는 도서관___.",             answer:"이에요",     answers:["이에요","이에요."],      hint:"💡 받침 있음 → 이에요" },
      { id:"t7_3",  q:"이분은 교장 선생님___.",        answer:"이세요",     answers:["이세요","이세요."],      hint:"💡 높임 → 이세요" },
      { id:"t7_4",  q:"여기는 카페___.",               answer:"예요",       answers:["예요","예요."],          hint:"💡 받침 없음 → 예요" },
      { id:"t7_5",  q:"저는 한국 사람이 ___.",         answer:"아니에요",   answers:["아니에요","아니에요."],  hint:"💡 아니다 → 아니에요" },
      { id:"t7_6",  q:"여기는 학교가 ___.",            answer:"아니에요",   answers:["아니에요","아니에요."],  hint:"💡 아니다 → 아니에요" },
      ...
      { id:"t7_13", q:"책상 위에 책이 ___.",           answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 위치 + 있어요" },
      { id:"t7_14", q:"가방 안에 지갑이 ___.",         answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 안 = inside" },
      { id:"t7_15", q:"은행 옆에 편의점이 ___.",       answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 옆 = beside" },
      ...
      { id:"t7_21", q:"이 음식이 ___.",                answer:"달아요",     answers:["달아요","달아요."],      hint:"💡 달다 → 달아요" },
      { id:"t7_22", q:"저는 한국어가 ___.",            answer:"재미있어요", answers:["재미있어요","재미있어요."],hint:"💡 재미있다" },
      { id:"t7_23", q:"이 식당이 ___.",                answer:"비싸요",     answers:["비싸요","비싸요."],      hint:"💡 비싸다 → 비싸요" },
      ...
      { id:"t7_34", q:"먹다 → ___",                   answer:"드세요",     answers:["드세요","드세요.","먹으세요"],hint:"💡 먹다 높임 → 드세요" },
      { id:"t7_35", q:"말하다 → ___",                 answer:"말하세요",   answers:["말하세요","말하세요."],  hint:"💡 하다 계열 → 하세요" },
      { id:"t7_36", q:"천천히 ___. (걷다)",            answer:"걸으세요",   answers:["걸으세요","걸으세요."],  hint:"💡 걷다 → ㄷ불규칙 → 걸으세요" },
      // ── 6단원: 연결어미 (이유·대조·나열) (8문항) ──
      { id:"t7_37", q:"비싸___ 좋아요. (대조)",        answer:"지만",       answers:["지만"],                  hint:"💡 대조 → 지만" },
      { id:"t7_38", q:"배가 고파___ 밥 먹어요. (이유)",answer:"서",         answers:["서","서요"],             hint:"💡 이유 → 아/어서" },
      { id:"t7_39", q:"한국어가 재미있___ 어려워요.",   answer:"지만",       answers:["지만"],                  hint:"💡 대조 → 지만" },
      { id:"t7_40", q:"비가 오___ 우산 있어요?",       answer:"는데",       answers:["는데"],                  hint:"💡 배경·상황 → 는데" },
      { id:"t7_41", q:"피곤하___ 일해요.",             answer:"지만",       answers:["지만"],                  hint:"💡 대조 → 지만" },
      ...
      { id:"t7_44", q:"날씨가 좋___ 산책해요.",        answer:"아서",       answers:["아서","아서요"],         hint:"💡 이유 → 아서" },
      // ── 7단원: 현재진행 -고 있어요 (20문항) ──
