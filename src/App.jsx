...
힌트는 반드시 '받침 없음 → ...' 또는 '받침 있음 → ...' 형식으로 작성`}]
  ...
  if (step === "test8") {
    ...
    const TEST8_Q = [
      ...
      { id:"t8_5",  q:"저는 학생___. (받침 있음)",            answer:"입니다",  answers:["입니다","입니다."],   hint:"💡 이에요/예요" },
      { id:"t8_6",  q:"시간이 ___. (없음)",                   answer:"없습니다",  answers:["없습니다","없습니다."],   hint:"💡 없다" },
      { id:"t8_7",  q:"이 가방이 ___. (크다→으탈락)",        answer:"큽니다",  answers:["큽니다","큽니다."],        hint:"💡 크다 → 커요" },
      { id:"t8_8",  q:"학교에 ___ 공부해요. (이유)",         answer:"가서",    answers:["가서"],               hint:"💡 가다+아/어서" },
      { id:"t8_9",  q:"지금 밥을 먹고 ___. (진행)",          answer:"있습니다",  answers:["있습니다","있습니다."],   hint:"💡 -고 있다" },
  ...
  if (step === "test12") {
    ...
    const TEST12_Q = [
      ...
      { id:"t12_8",  q:"저는 한국어를 말할 ___ ___. (가능)",      answer:"수 있습니다",answers:["수 있습니다","수 있습니다."],  hint:"💡 -(으)ㄹ 수 있다" },
