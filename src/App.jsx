...
힌트는 반드시 '받침 없음 → ...' 또는 '받침 있음 → ...' 형식으로 작성`}]
  ...
  if (step === "test4") {
    ...
    const TEST4_QUESTIONS = [
      // ── 1단원 복습 10문제
      { id:"t4_1",  q:"저는 학생___.",         answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 학생 → 받침 있음" },
      { id:"t4_2",  q:"여기는 학교___.",        answer:"입니다",  answers:["입니다","입니다."],      hint:"💡 학교 → 받침 없음" },
      { id:"t4_3",  q:"오늘은 금요일___.",       answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 금요일 → 받침 있음" },
      { id:"t4_4",  q:"저는 경찰___.",           answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 경찰 → 받침 있음" },
      { id:"t4_5",  q:"이분은 의사___.",          answer:"이세요",  answers:["이세요","이세요."],  hint:"💡 높임말 (어른께 쓰는 말)" },
      { id:"t4_6",  q:"저는 일본 사람___.",       answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 사람 → 받침 있음" },
      { id:"t4_7",  q:"여기는 은행___.",          answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 은행 → 받침 있음" },
      { id:"t4_8",  q:"저 분은 동생___.",         answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 동생 → 받침 있음" },
      { id:"t4_9",  q:"여기는 카페___.",          answer:"입니다",  answers:["입니다","입니다."],      hint:"💡 카페 → 받침 없음" },
      { id:"t4_10", q:"저는 대학교 학생___.",     answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 학생 → 받침 있음" },
      // ── 2단원 복습 10문제
      { id:"t4_11", q:"시간이 ___.",             answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 있다" },
      { id:"t4_12", q:"돈이 ___.",               answer:"없습니다",  answers:["없습니다","없습니다."],  hint:"💡 없다" },
      { id:"t4_13", q:"친구가 ___.",             answer:"많습니다",  answers:["많습니다","많습니다."],  hint:"💡 많다" },
      { id:"t4_14", q:"학생이 ___.",             answer:"적습니다",  answers:["적습니다","적습니다."],  hint:"💡 적다" },
      { id:"t4_15", q:"오늘 일이 ___.",          answer:"많습니다",  answers:["많습니다","많습니다."],  hint:"💡 많다" },
      { id:"t4_16", q:"지갑에 카드가 ___.",      answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 있다" },
      { id:"t4_17", q:"오늘 버스가 ___.",        answer:"없습니다",  answers:["없습니다","없습니다."],  hint:"💡 없다" },
      { id:"t4_18", q:"교실에 창문이 ___.",      answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 있다" },
      { id:"t4_19", q:"오늘 손님이 ___.",        answer:"적습니다",  answers:["적습니다","적습니다."],  hint:"💡 적다" },
      { id:"t4_20", q:"가방에 책이 ___.",        answer:"많습니다",  answers:["많습니다","많습니다."],  hint:"💡 많다" },
      // ── 3단원 복습 10문제
      ...
      { id:"t4_36", q:"___ 이 친구예요? (주어)", answer:"누가",   answers:["누가"],                    hint:"💡 주어 자리 (사람+이/가)" },
      ...
      // ── 2단원B 위치표현 (보완 6문항) ──
      { id:"t4_41", q:"책상 위에 책이 ___.",           answer:"있습니다",  answers:["있습니다","있습니다."],       hint:"💡 위(above) → 뭐가 있어요?" },
      { id:"t4_42", q:"가방 안에 지갑이 ___.",         answer:"있습니다",  answers:["있습니다","있습니다."],       hint:"💡 안(inside) → 있습니다" },
      { id:"t4_43", q:"은행 옆에 편의점이 ___.",       answer:"있습니다",  answers:["있습니다","있습니다."],       hint:"💡 옆(beside) → 있습니다" },
      { id:"t4_44", q:"냉장고 앞에 고양이가 ___.",     answer:"있습니다",  answers:["있습니다","있습니다."],       hint:"💡 앞(in front) → 있습니다" },
      { id:"t4_45", q:"화장실이 어디에 ___?",          answer:"있어요",  answers:["있어요","있어요?"],       hint:"💡 장소를 물을 때 → 있습니까?" },
      { id:"t4_46", q:"의자 아래에 가방이 ___.",       answer:"있습니다",  answers:["있습니다","있습니다."],       hint:"💡 아래(below) → 있습니다" },
      // ── 3단원 추가 보완 (ㅂ불규칙 강화 4문항) ──
      { id:"t4_47", q:"오늘 날씨가 ___.",              answer:"춥습니다",  answers:["춥습니다","춥습니다."],       hint:"💡 춥다 → ㅂ불규칙" },
      { id:"t4_48", q:"이 짐이 ___.",                  answer:"무겁습니다",answers:["무겁습니다","무겁습니다."],   hint:"💡 무겁다 → ㅂ불규칙" },
      { id:"t4_49", q:"여름에 날씨가 ___.",            answer:"덥습니다",  answers:["덥습니다","덥습니다."],       hint:"💡 덥다 → ㅂ불규칙" },
      { id:"t4_50", q:"이 식당이 ___.",                answer:"쌉니다",  answers:["쌉니다","쌉니다."],           hint:"💡 싸다 (가격이 낮음)" },
    ];
  ...
  if (step === "test5") {
    ...
    const TEST5_QUESTIONS = [
      // ── 1단원 복습 10문제
      { id:"t5_1",  q:"저는 선생님___.",        answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 선생님 → 받침 있음" },
      { id:"t5_2",  q:"여기는 카페___.",         answer:"입니다",  answers:["입니다","입니다."],      hint:"💡 카페 → 받침 없음" },
      { id:"t5_3",  q:"오늘은 토요일___.",        answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 토요일 → 받침 있음" },
      { id:"t5_4",  q:"저는 회사원___.",          answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 회사원 → 받침 있음" },
      { id:"t5_5",  q:"이분은 원장님___.",         answer:"이세요",  answers:["이세요","이세요."],  hint:"💡 높임말 (어른께 쓰는 말)" },
      { id:"t5_6",  q:"저는 필리핀 사람___.",     answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 사람 → 받침 있음" },
      { id:"t5_7",  q:"여기는 공항___.",           answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 공항 → 받침 있음" },
      { id:"t5_8",  q:"저 분은 팀장님___.",        answer:"이세요",  answers:["이세요","이세요."],  hint:"💡 높임말 (어른께 쓰는 말)" },
      { id:"t5_9",  q:"여기는 편의점___.",          answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 편의점 → 받침 있음" },
      { id:"t5_10", q:"저는 대학원생___.",          answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 대학원생 → 받침 있음" },
      // ── 2단원 복습 10문제
      { id:"t5_11", q:"오늘 시간이 ___.",          answer:"없습니다",  answers:["없습니다","없습니다."],  hint:"💡 없다" },
      { id:"t5_12", q:"사람이 ___.",               answer:"많습니다",  answers:["많습니다","많습니다."],  hint:"💡 많다" },
      { id:"t5_13", q:"주머니에 돈이 ___.",        answer:"없습니다",  answers:["없습니다","없습니다."],  hint:"💡 없다" },
      { id:"t5_14", q:"오늘 할 일이 ___.",         answer:"많습니다",  answers:["많습니다","많습니다."],  hint:"💡 많다" },
      { id:"t5_15", q:"교실에 학생이 ___.",        answer:"적습니다",  answers:["적습니다","적습니다."],  hint:"💡 적다" },
      { id:"t5_16", q:"냉장고에 음식이 ___.",      answer:"없습니다",  answers:["없습니다","없습니다."],  hint:"💡 없다" },
      { id:"t5_17", q:"오늘 손님이 ___.",          answer:"많습니다",  answers:["많습니다","많습니다."],  hint:"💡 많다" },
      { id:"t5_18", q:"지금 여유가 ___.",          answer:"없습니다",  answers:["없습니다","없습니다."],  hint:"💡 없다" },
      { id:"t5_19", q:"오늘 버스에 사람이 ___.",   answer:"적습니다",  answers:["적습니다","적습니다."],  hint:"💡 적다" },
      { id:"t5_20", q:"책상 위에 책이 ___.",       answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 있다" },
      // ── 3단원 복습 10문제
      ...
      { id:"t5_36", q:"___ 이 선생님이에요? (주어)", answer:"누가", answers:["누가"],                     hint:"💡 주어 자리 (사람+이/가)" },
      ...
      { id:"t5_45", q:"알다 → ___ (높임)",          answer:"아세요",    answers:["아세요","아세요."],      hint:"💡 알다 → ㄹ 탈락 → ___세요" },
      { id:"t5_46", q:"살다 → ___ (높임)",          answer:"사세요",    answers:["사세요","사세요."],      hint:"💡 살다 → ㄹ 탈락 → ___세요" },
      ...
      { id:"t5_53", q:"천천히 걷다 → ___",            answer:"걸으세요",  answers:["걸으세요","걸으세요."],   hint:"💡 걷다 → ㄷ불규칙 변환" },
      ...
      { id:"t5_58", q:"줄다 → ___ (ㄹ탈락)",         answer:"주세요",    answers:["주세요","주세요."],       hint:"💡 줄다 → ㄹ탈락 불규칙" },
  ...
  if (step === "test6") {
    ...
    const TEST6_QUESTIONS = [
      // ── 1단원 복습 5문제
      { id:"t6_1",  q:"저는 의사___.",            answer:"입니다",  answers:["입니다","입니다."],      hint:"💡 받침 없음 → __요" },
      { id:"t6_2",  q:"오늘은 금요일___.",          answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 받침 있음 → 이__요" },
      { id:"t6_3",  q:"이분은 원장님___.",           answer:"이세요",  answers:["이세요","이세요."],  hint:"💡 높임말 (어른께 쓰는 말)" },
      { id:"t6_4",  q:"저는 베트남 사람___.",        answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 받침 있음" },
      { id:"t6_5",  q:"여기는 도서관___.",           answer:"입니다",  answers:["입니다","입니다."],  hint:"💡 받침 있음" },
      // ── 2A단원 복습 5문제
      { id:"t6_6",  q:"오늘 시간이 ___.",           answer:"없습니다",  answers:["없습니다","없습니다."],  hint:"💡 없다" },
      { id:"t6_7",  q:"교실에 학생이 ___.",          answer:"많습니다",  answers:["많습니다","많습니다."],  hint:"💡 많다" },
      { id:"t6_8",  q:"냉장고에 음식이 ___.",        answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 있다" },
      { id:"t6_9",  q:"오늘 버스에 사람이 ___.",     answer:"적습니다",  answers:["적습니다","적습니다."],  hint:"💡 적다" },
      { id:"t6_10", q:"지갑에 돈이 ___.",           answer:"없습니다",  answers:["없습니다","없습니다."],  hint:"💡 없다" },
      // ── 2B단원 복습 5문제
      { id:"t6_11", q:"화장실이 어디에 ___?",        answer:"있어요",  answers:["있어요","있어요?"],  hint:"💡 위치 표현 → 있습니다" },
      { id:"t6_12", q:"가방 안에 지갑이 ___.",       answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 안(inside) → 있습니다" },
      { id:"t6_13", q:"은행 옆에 편의점이 ___.",     answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 옆(beside) → 있습니다" },
      { id:"t6_14", q:"책상 위에 책이 ___.",         answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 위(above) → 뭐가 있어요?" },
      { id:"t6_15", q:"냉장고 앞에 고양이가 ___.",   answer:"있습니다",  answers:["있습니다","있습니다."],  hint:"💡 앞(in front) → 있습니다" },
      // ── 3A단원 복습 5문제
      { id:"t6_16", q:"날씨가 ___.",               answer:"좋아요",     answers:["좋아요","좋아요."],     hint:"💡 좋다" },
      { id:"t6_17", q:"이 가방이 ___.",             answer:"커요",       answers:["커요","커요."],         hint:"💡 크다 → ㅡ탈락" },
      { id:"t6_18", q:"한국어가 ___.",              answer:"재미있어요", answers:["재미있어요","재미있어요."], hint:"💡 재미있다" },
      { id:"t6_19", q:"이 식당이 ___.",             answer:"싸요",       answers:["싸요","싸요."],         hint:"💡 싸다" },
      { id:"t6_20", q:"음식이 ___.",               answer:"맛있어요",   answers:["맛있어요","맛있어요."],  hint:"💡 맛있다" },
      // ── 3B단원 복습 5문제
      { id:"t6_21", q:"오늘 날씨가 ___.",           answer:"추워요",   answers:["추워요","추워요."],   hint:"💡 춥다 → ㅂ불규칙" },
      { id:"t6_22", q:"한국어가 ___.",              answer:"어려워요", answers:["어려워요","어려워요."], hint:"💡 어렵다 → ㅂ불규칙" },
      { id:"t6_23", q:"이 짐이 ___.",               answer:"무거워요", answers:["무거워요","무거워요."], hint:"💡 무겁다 → ㅂ불규칙" },
      { id:"t6_24", q:"이 음식이 ___.",             answer:"매워요",   answers:["매워요","매워요."],   hint:"💡 맵다 → ㅂ불규칙" },
      { id:"t6_25", q:"여름에 날씨가 ___.",         answer:"더워요",   answers:["더워요","더워요."],   hint:"💡 덥다 → ㅂ불규칙" },
      // ── 4단원 복습 5문제
      { id:"t6_26", q:"___ 예요? (사람)",           answer:"누구",  answers:["누구","누구요"],       hint:"💡 사람" },
      { id:"t6_27", q:"___ 가요? (장소)",           answer:"어디",  answers:["어디","어디요"],       hint:"💡 장소" },
      { id:"t6_28", q:"___ 해요? (이유)",           answer:"왜",    answers:["왜","왜요"],          hint:"💡 이유" },
      { id:"t6_29", q:"___ 먹어요? (사물)",         answer:"뭐",    answers:["뭐","무엇"],          hint:"💡 사물" },
      { id:"t6_30", q:"___ 친구예요? (주어)",       answer:"누가",  answers:["누가"],               hint:"💡 주어 자리 (사람+이/가)" },
      // ── 5단원 복습 5문제
      { id:"t6_31", q:"앉다 → ___",               answer:"앉으세요",  answers:["앉으세요","앉으세요."], hint:"💡 받침 있음 → 으세요" },
      { id:"t6_32", q:"오다 → ___",               answer:"오세요",    answers:["오세요","오세요."],    hint:"💡 받침 없음 → 세요" },
      { id:"t6_33", q:"먹다 → ___ (높임)",         answer:"드세요",    answers:["드세요","드세요."],    hint:"💡 특별 높임말" },
      { id:"t6_34", q:"알다 → ___ (높임)",         answer:"아세요",    answers:["아세요","아세요."],    hint:"💡 ㄹ 탈락 → ___세요" },
      { id:"t6_35", q:"살다 → ___ (높임)",         answer:"사세요",    answers:["사세요","사세요."],    hint:"💡 ㄹ 탈락 → ___세요" },
      // ── 6A단원 10문제 (연결어)
      { id:"t6_36", q:"저는 커피를 좋아해요. ___ 차도 좋아해요.", answer:"그리고",  answers:["그리고"],  hint:"💡 추가 → ___" },
      { id:"t6_37", q:"날씨가 좋아요. ___ 바람이 불어요.",       answer:"그런데",  answers:["그런데"],  hint:"💡 전환 → ___" },
      { id:"t6_38", q:"한국어가 재미있어요. ___ 어려워요.",       answer:"하지만",  answers:["하지만","그러나"],  hint:"💡 강한 반대 (접속사)" },
      { id:"t6_39", q:"비가 와요. ___ 우산을 가져왔어요.",        answer:"그래서",  answers:["그래서"],  hint:"💡 결과 → ___" },
      { id:"t6_40", q:"배가 고파요. ___ 밥을 먹었어요.",          answer:"그래서",  answers:["그래서"],  hint:"💡 원인→결과 → ___" },
      { id:"t6_41", q:"저는 한국 음식을 좋아해요. ___ 매운 건 못 먹어요.", answer:"하지만", answers:["하지만","그러나"], hint:"💡 강한 반대 (접속사)" },
      // ── 6B단원 10문제 (연결어미)
      { id:"t6_42", q:"밥을 먹___ 영화를 봐요.",         answer:"고",  answers:["고"],  hint:"💡 나열 → -고" },
      { id:"t6_43", q:"저는 키가 크___ 마르다.",         answer:"고",  answers:["고"],  hint:"💡 나열 → -고" },
      { id:"t6_44", q:"비가 오___ 바람이 불어요.",       answer:"고",  answers:["고"],  hint:"💡 동시 → -고" },
      { id:"t6_45", q:"한국어가 재미있___ 어려워요.",    answer:"지만",answers:["지만"],hint:"💡 반대 표현 (한 문장)" },
      { id:"t6_46", q:"값이 비싸___ 좋아요.",           answer:"지만",answers:["지만"],hint:"💡 반대 표현 (한 문장)" },
      { id:"t6_47", q:"배가 고파___ 밥을 먹어요.",      answer:"서",  answers:["서"],  hint:"💡 이유 → -아/어서" },
      { id:"t6_48", q:"날씨가 좋___ 공원에 가요.",      answer:"아서",answers:["아서","서"],hint:"💡 이유/순서 (아 계열)" },
      { id:"t6_49", q:"피곤하___ 일찍 자요.",           answer:"서",  answers:["서","아서","어서"],hint:"💡 이유 → -아/어서" },
      { id:"t6_50", q:"친구를 만나___ 밥을 먹었어요.",  answer:"서",  answers:["서","아서","어서"],hint:"💡 순서 → -아/어서" },
      { id:"t6_51", q:"음식이 맛있___ 많이 먹었어요.",  answer:"어서",answers:["어서","서"],hint:"💡 이유/순서 (어 계열)" },
      { id:"t6_52", q:"배가 불___ 디저트는 안 먹어요.", answer:"지만",answers:["지만"],hint:"💡 반대 표현 (한 문장)" },
      // ── 6A 보강 4문제 (그러면·그래도·아니면·그렇지만)
      { id:"t6_53", q:"시간이 있어요. ___ 같이 가요.",          answer:"그러면",  answers:["그러면"],              hint:"💡 앞 상황→제안 → ___" },
      { id:"t6_54", q:"비싸요. ___ 살 거예요.",                  answer:"그래도",  answers:["그래도"],              hint:"💡 양보 → ___" },
      { id:"t6_55", q:"커피예요, ___ 차예요?",                   answer:"아니면",  answers:["아니면"],              hint:"💡 선택 질문 → ___" },
      { id:"t6_56", q:"한국어가 재미있어요. ___ 어려워요.",      answer:"하지만",  answers:["하지만","그러나","그렇지만"], hint:"💡 강한 반대 (접속사 3가지)" },
      // ── 6C단원 6문제 (-(으)면·-(으)니까·-는데)
      { id:"t6_57", q:"시간이 있___ 와요.",           answer:"으면",   answers:["으면"],        hint:"💡 조건 표현 (받침 있음)" },
      { id:"t6_58", q:"한국에 가___ 한국어를 배워요.", answer:"면",     answers:["면"],          hint:"💡 조건 표현 (받침 없음)" },
      { id:"t6_59", q:"날씨가 좋___ 공원에 가요.",    answer:"으면",   answers:["으면"],        hint:"💡 조건 표현 (받침 있음)" },
      { id:"t6_60", q:"바쁘___ 못 가요.",             answer:"니까",   answers:["니까"],        hint:"💡 이유 표현 (받침 없음)" },
      { id:"t6_61", q:"늦었___ 빨리 가요.",           answer:"으니까", answers:["으니까"],      hint:"💡 이유 표현 (받침 있음)" },
      { id:"t6_62", q:"비가 오___ 우산 있어요?",      answer:"는데",   answers:["는데"],        hint:"💡 동사+배경연결 (동작 중 상황)" },
      // ── 6단원 연결어미 추가 보완 (14문항) ──
      { id:"t6_63", q:"공부하___ 친구를 만나요. (나열)",     answer:"고",     answers:["고"],               hint:"💡 나열 → -고" },
      { id:"t6_64", q:"음악을 듣___ 밥을 먹어요. (동시)",   answer:"고",     answers:["고"],               hint:"💡 동시 → -고" },
      { id:"t6_65", q:"저는 키가 작___ 힘이 세요. (대조)",  answer:"지만",   answers:["지만"],             hint:"💡 반대·대조 표현" },
      { id:"t6_66", q:"돈이 없___ 행복해요. (대조)",        answer:"지만",   answers:["지만"],             hint:"💡 반대·대조 표현" },
      ...
      { id:"t6_71", q:"시간이 있___ 도와드릴게요. (조건)",  answer:"으면",   answers:["으면"],             hint:"💡 조건 표현 (받침 있음)" },
      ...
      { id:"t6_74", q:"피곤하___ 일찍 자야 해요. (이유)",   answer:"니까",   answers:["니까"],             hint:"💡 이유 표현 (받침 없음)" },
      { id:"t6_75", q:"밥을 많이 먹었___ 배불러요. (이유)", answer:"으니까", answers:["으니까"],           hint:"💡 이유 표현 (받침 있음)" },
      { id:"t6_76", q:"저는 한국어가 좋___ 매일 공부해요.", answer:"아서",   answers:["아서","서"],         hint:"💡 좋다 이유 표현" },
    ];
  ...
  if (step === "test7") {
    ...
    const TEST7_QUESTIONS = [
      // ── 1단원: 이에요/예요/아니에요 (8문항) ──
      { id:"t7_1",  q:"저는 회사원___.",              answer:"이에요",     answers:["이에요","이에요."],      hint:"💡 받침 있음 (이__요)" },
      { id:"t7_2",  q:"여기는 도서관___.",             answer:"이에요",     answers:["이에요","이에요."],      hint:"💡 받침 있음 (이__요)" },
      { id:"t7_3",  q:"이분은 교장 선생님___.",        answer:"이세요",     answers:["이세요","이세요."],      hint:"💡 높임말 (어른께 쓰는 말)" },
      { id:"t7_4",  q:"여기는 카페___.",               answer:"예요",       answers:["예요","예요."],          hint:"💡 받침 없음 (__요)" },
      { id:"t7_5",  q:"저는 한국 사람이 ___.",         answer:"아니에요",   answers:["아니에요","아니에요."],  hint:"💡 아니다 (부정)" },
      { id:"t7_6",  q:"여기는 학교가 ___.",            answer:"아니에요",   answers:["아니에요","아니에요."],  hint:"💡 아니다 (부정)" },
      { id:"t7_7",  q:"저는 의사___.",                 answer:"예요",       answers:["예요","예요."],          hint:"💡 의사 → 받침 없음" },
      { id:"t7_8",  q:"오늘은 월요일___.",              answer:"이에요",     answers:["이에요","이에요."],      hint:"💡 월요일 → 받침 있음" },
      // ── 2단원: 있다/없다/많다/적다 + 위치 (8문항) ──
      { id:"t7_9",  q:"오늘 일이 ___.",               answer:"많아요",     answers:["많아요","많아요."],      hint:"💡 많다" },
      { id:"t7_10", q:"교실에 학생이 ___.",            answer:"적어요",     answers:["적어요","적어요."],      hint:"💡 적다" },
      { id:"t7_11", q:"시간이 ___.",                   answer:"없어요",     answers:["없어요","없어요."],      hint:"💡 없다" },
      { id:"t7_12", q:"냉장고에 음식이 ___.",          answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 있다" },
      { id:"t7_13", q:"책상 위에 책이 ___.",           answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 위치 표현 → 있습니다" },
      { id:"t7_14", q:"가방 안에 지갑이 ___.",         answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 안(inside) → 있습니다" },
      { id:"t7_15", q:"은행 옆에 편의점이 ___.",       answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 옆(beside) → 있습니다" },
      { id:"t7_16", q:"우리 반 학생이 ___.",           answer:"많아요",     answers:["많아요","많아요."],      hint:"💡 많다" },
      // ── 3단원: 형용사 서술어 (규칙 + ㅂ불규칙) (8문항) ──
      { id:"t7_17", q:"날씨가 ___.",                   answer:"좋아요",     answers:["좋아요","좋아요."],      hint:"💡 좋다" },
      { id:"t7_18", q:"이 음식이 ___.",                answer:"매워요",     answers:["매워요","매워요."],      hint:"💡 맵다 → ㅂ불규칙" },
      { id:"t7_19", q:"이 가방이 ___.",                answer:"커요",       answers:["커요","커요."],          hint:"💡 크다 → ㅡ탈락" },
      { id:"t7_20", q:"오늘 날씨가 ___.",              answer:"추워요",     answers:["추워요","추워요."],      hint:"💡 춥다 → ㅂ불규칙" },
      { id:"t7_21", q:"이 음식이 ___.",                answer:"달아요",     answers:["달아요","달아요."],      hint:"💡 달다 (단맛)" },
      { id:"t7_22", q:"저는 한국어가 ___.",            answer:"재미있어요", answers:["재미있어요","재미있어요."],hint:"💡 재미있다" },
      { id:"t7_23", q:"이 식당이 ___.",                answer:"비싸요",     answers:["비싸요","비싸요."],      hint:"💡 비싸다 (가격이 높음)" },
      { id:"t7_24", q:"오늘 기분이 ___.",              answer:"좋아요",     answers:["좋아요","좋아요."],      hint:"💡 좋다" },
      // ── 4단원: 의문대명사 (6문항) ──
      { id:"t7_25", q:"___ 가요? (장소)",             answer:"어디",       answers:["어디","어디요"],         hint:"💡 장소" },
      { id:"t7_26", q:"___ 예요? (사람)",             answer:"누구",       answers:["누구","누구예요"],       hint:"💡 사람" },
      { id:"t7_27", q:"___ 먹어요? (사물)",           answer:"뭐",         answers:["뭐","무엇"],             hint:"💡 사물" },
      { id:"t7_28", q:"___ 해요? (때)",               answer:"언제",       answers:["언제"],                  hint:"💡 때·시간" },
      { id:"t7_29", q:"___ 왔어요? (방법)",           answer:"어떻게",     answers:["어떻게"],                hint:"💡 방법" },
      { id:"t7_30", q:"이게 ___ 예요? (값)",          answer:"얼마",       answers:["얼마"],                  hint:"💡 값·가격" },
      // ── 5단원: ~(으)세요 명령 (6문항) ──
      { id:"t7_31", q:"앉다 → ___",                   answer:"앉으세요",   answers:["앉으세요","앉으세요."],  hint:"💡 받침 있음 → 으세요" },
      { id:"t7_32", q:"읽다 → ___",                   answer:"읽으세요",   answers:["읽으세요","읽으세요."],  hint:"💡 받침 있음 → 으세요" },
      { id:"t7_33", q:"오다 → ___",                   answer:"오세요",     answers:["오세요","오세요."],      hint:"💡 받침 없음 → 세요" },
      { id:"t7_34", q:"먹다 → ___",                   answer:"드세요",     answers:["드세요","드세요.","먹으세요"],hint:"💡 먹다 높임말 (특별형)" },
      { id:"t7_35", q:"말하다 → ___",                 answer:"말하세요",   answers:["말하세요","말하세요."],  hint:"💡 하다 계열 → 하세요" },
      { id:"t7_36", q:"천천히 ___. (걷다)",            answer:"걸으세요",   answers:["걸으세요","걸으세요."],  hint:"💡 걷다 → ㄷ불규칙 변환" },
      // ── 6단원: 연결어미 (이유·대조·나열) (8문항) ──
      { id:"t7_37", q:"비싸___ 좋아요. (대조)",        answer:"지만",       answers:["지만"],                  hint:"💡 대조 표현" },
      { id:"t7_38", q:"배가 고파___ 밥 먹어요. (이유)",answer:"서",         answers:["서","서요"],             hint:"💡 이유 → 아/어서" },
      { id:"t7_39", q:"한국어가 재미있___ 어려워요.",   answer:"지만",       answers:["지만"],                  hint:"💡 대조 표현" },
      { id:"t7_40", q:"비가 오___ 우산 있어요?",       answer:"는데",       answers:["는데"],                  hint:"💡 동사+배경연결 (동작 중 상황)" },
      { id:"t7_41", q:"피곤하___ 일해요.",             answer:"지만",       answers:["지만"],                  hint:"💡 대조 표현" },
      { id:"t7_42", q:"학교에 가___ 한국어를 배워요.", answer:"서",         answers:["서","서요"],             hint:"💡 순서/이유 → 아/어서" },
      { id:"t7_43", q:"밥___ 먹___ 커피 마셔요. (나열)",answer:"도",        answers:["도"],                    hint:"💡 나열 → 도" },
      { id:"t7_44", q:"날씨가 좋___ 산책해요.",        answer:"아서",       answers:["아서","아서요"],         hint:"💡 이유/순서 (아 계열)" },
      // ── 7단원: 현재진행 -고 있어요 (20문항) ──
      { id:"t7_45", q:"지금 밥 먹___ 있어요.",         answer:"고",         answers:["고"],                    hint:"💡 동사 원형 + 고" },
      { id:"t7_46", q:"친구가 전화하___ 있어요.",      answer:"고",         answers:["고"],                    hint:"💡 하다 + 고" },
      { id:"t7_47", q:"아이가 자고 ___.",              answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 자고 있___" },
      { id:"t7_48", q:"저는 한국어 공부하___ 있어요.", answer:"고",         answers:["고"],                    hint:"💡 공부하다 + 고" },
      { id:"t7_49", q:"엄마가 요리하고 ___.",          answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 하고 있___" },
      { id:"t7_50", q:"비가 오고 ___.",                answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 오고 있___" },
      { id:"t7_51", q:"지금 뭐 하___ 있어요?",         answer:"고",         answers:["고"],                    hint:"💡 하다 + 고" },
      { id:"t7_52", q:"동생이 음악 듣___ 있어요.",     answer:"고",         answers:["고"],                    hint:"💡 듣다 원형 + 고" },
      { id:"t7_53", q:"저는 지금 일하고 ___.",         answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 일하고 있___" },
      { id:"t7_54", q:"친구가 공원에서 달리___ 있어요.",answer:"고",        answers:["고"],                    hint:"💡 달리다 + 고" },
      { id:"t7_55", q:"선생님이 책을 읽___ 있어요.",   answer:"고",         answers:["고"],                    hint:"💡 읽다 원형 + 고" },
      { id:"t7_56", q:"저는 지금 커피를 마시___ 있어요.",answer:"고",       answers:["고"],                    hint:"💡 마시다 + 고" },
      { id:"t7_57", q:"엄마가 전화하고 ___.",          answer:"있어요",     answers:["있어요","있어요."],      hint:"💡 하고 있___" },
      { id:"t7_58", q:"아이들이 노래를 부르___ 있어요.",answer:"고",        answers:["고"],                    hint:"💡 부르다 + 고" },
      { id:"t7_59", q:"지금 눈이 오___ 있어요.",       answer:"고",         answers:["고"],                    hint:"💡 오다 + 고" },
      { id:"t7_60", q:"형이 지금 운동하___ 있어요.",   answer:"고",         answers:["고"],                    hint:"💡 하다 계열 + 고" },
      { id:"t7_61", q:"저는 지금 한국어를 공부하고 ___.",answer:"있어요",   answers:["있어요","있어요."],      hint:"💡 공부하고 있___" },
      ...
      { id:"t7_67", q:"저는 키가 작___ 힘이 세요. (대조)",   answer:"지만",   answers:["지만"],             hint:"💡 반대·대조 표현" },
      { id:"t7_68", q:"돈이 없___ 행복해요. (대조)",         answer:"지만",   answers:["지만"],             hint:"💡 반대·대조 표현" },
      ...
      { id:"t7_71", q:"시간이 있___ 도와드릴게요. (조건)",   answer:"으면",   answers:["으면"],             hint:"💡 조건 표현 (받침 있음)" },
      { id:"t7_72", q:"한국어를 잘 하___ 좋겠어요. (조건)",  answer:"면",     answers:["면"],               hint:"💡 받침 없음 → -면" },
      { id:"t7_73", q:"피곤하___ 일찍 자야 해요. (이유)",    answer:"니까",   answers:["니까"],             hint:"💡 이유 표현 (받침 없음)" },
      { id:"t7_74", q:"밥을 많이 먹었___ 배불러요. (이유)",  answer:"으니까", answers:["으니까"],           hint:"💡 이유 표현 (받침 있음)" },
      { id:"t7_75", q:"저는 한국어가 좋___ 매일 공부해요.",  answer:"아서",   answers:["아서","서"],         hint:"💡 좋다 이유 표현" },
      ...
      { id:"t7_78", q:"비가 오___ 우산 있어요? (배경)",      answer:"는데",   answers:["는데"],             hint:"💡 동사+배경연결 (동작 중 상황)" },
      // ── 7단원 현재진행 추가 복습 (12문항) ──
      { id:"t7_79", q:"저는 지금 책을 읽___ 있어요.",        answer:"고",     answers:["고"],               hint:"💡 읽다 + 고" },
      { id:"t7_80", q:"아이들이 운동장에서 뛰___ 있어요.",   answer:"고",     answers:["고"],               hint:"💡 뛰다 + 고" },
      { id:"t7_81", q:"엄마가 전화하고 ___.",               answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 하고 있___" },
      { id:"t7_82", q:"선생님이 칠판에 쓰___ 있어요.",       answer:"고",     answers:["고"],               hint:"💡 쓰다 + 고" },
      { id:"t7_83", q:"저는 지금 영화를 보고 ___.",          answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 보고 있___" },
      ...
      { id:"t7_87", q:"저는 지금 숙제를 하고 ___.",          answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 하고 있___" },
  ...
  if (step === "test8") {
    ...
    const TEST8_Q = [
      // ── 1단원: 이다·아니다·이세요 (8문항) ──
      { id:"t8_1",  q:"저는 회사원___.",              answer:"입니다",    answers:["입니다","입니다."],     hint:"💡 받침 있음 → 입니다" },
      { id:"t8_2",  q:"여기는 도서관___.",             answer:"입니다",    answers:["입니다","입니다."],     hint:"💡 받침 있음 → 입니다" },
      { id:"t8_3",  q:"이분은 교장 선생님___.",        answer:"이세요",    answers:["이세요","이세요."],     hint:"💡 높임말 → 이세요" },
      { id:"t8_4",  q:"여기는 카페___.",               answer:"입니다",    answers:["입니다","입니다."],     hint:"💡 받침 없음 → 입니다" },
      { id:"t8_5",  q:"저는 한국 사람이 ___.",         answer:"아닙니다",  answers:["아닙니다","아닙니다."], hint:"💡 아니다 → 아닙니다" },
      { id:"t8_6",  q:"여기는 학교가 ___.",            answer:"아닙니다",  answers:["아닙니다","아닙니다."], hint:"💡 아니다 → 아닙니다" },
      { id:"t8_7",  q:"저는 의사___.",                 answer:"입니다",    answers:["입니다","입니다."],     hint:"💡 받침 없음 → 입니다" },
      { id:"t8_8",  q:"오늘은 월요일___.",              answer:"입니다",    answers:["입니다","입니다."],     hint:"💡 받침 있음 → 입니다" },
      // ── 2단원: 있다/없다/많다/적다 + 위치 (8문항) ──
      { id:"t8_9",  q:"오늘 일이 ___.",               answer:"많습니다",  answers:["많습니다","많습니다."], hint:"💡 많다 → 많습니다" },
      { id:"t8_10", q:"교실에 학생이 ___.",            answer:"적습니다",  answers:["적습니다","적습니다."], hint:"💡 적다 → 적습니다" },
      { id:"t8_11", q:"시간이 ___.",                   answer:"없습니다",  answers:["없습니다","없습니다."], hint:"💡 없다 → 없습니다" },
      { id:"t8_12", q:"냉장고에 음식이 ___.",          answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 있다 → 있습니다" },
      { id:"t8_13", q:"책상 위에 책이 ___.",           answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 있다 → 있습니다" },
      { id:"t8_14", q:"가방 안에 지갑이 ___.",         answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 있다 → 있습니다" },
      { id:"t8_15", q:"은행 옆에 편의점이 ___.",       answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 있다 → 있습니다" },
      { id:"t8_16", q:"우리 반 학생이 ___.",           answer:"많습니다",  answers:["많습니다","많습니다."], hint:"💡 많다 → 많습니다" },
      // ── 3단원: 형용사 서술어 (규칙·ㅂ불규칙) (8문항) ──
      { id:"t8_17", q:"날씨가 ___. (좋다)",            answer:"좋습니다",  answers:["좋습니다","좋습니다."], hint:"💡 좋다 → 좋습니다" },
      { id:"t8_18", q:"이 음식이 ___. (맵다)",         answer:"맵습니다",  answers:["맵습니다","맵습니다."], hint:"💡 맵다 → ㅂ불규칙 → 맵습니다" },
      { id:"t8_19", q:"이 가방이 ___. (크다)",         answer:"큽니다",    answers:["큽니다","큽니다."],     hint:"💡 크다 → 으탈락 → 큽니다" },
      { id:"t8_20", q:"오늘 날씨가 ___. (춥다)",       answer:"춥습니다",  answers:["춥습니다","춥습니다."], hint:"💡 춥다 → ㅂ불규칙 → 춥습니다" },
      { id:"t8_21", q:"한국어가 ___. (재미있다)",      answer:"재미있습니다", answers:["재미있습니다","재미있습니다."], hint:"💡 재미있다 → 재미있습니다" },
      { id:"t8_22", q:"이 짐이 ___. (무겁다)",         answer:"무겁습니다", answers:["무겁습니다","무겁습니다."], hint:"💡 무겁다 → ㅂ불규칙 → 무겁습니다" },
      { id:"t8_23", q:"이 식당이 ___. (비싸다)",       answer:"비쌉니다",  answers:["비쌉니다","비쌉니다."],  hint:"💡 비싸다 → 비쌉니다" },
      { id:"t8_24", q:"오늘 기분이 ___. (좋다)",       answer:"좋습니다",  answers:["좋습니다","좋습니다."], hint:"💡 좋다 → 좋습니다" },
      // ── 4단원: 의문대명사 (6문항) ──
      { id:"t8_25", q:"___ 갑니까? (장소)",            answer:"어디",      answers:["어디"],                 hint:"💡 장소 의문대명사" },
      { id:"t8_26", q:"___ 입니까? (사람)",            answer:"누구",      answers:["누구"],                 hint:"💡 사람 의문대명사" },
      { id:"t8_27", q:"___ 먹습니까? (사물)",          answer:"무엇을",    answers:["무엇을","뭐"],           hint:"💡 사물 의문대명사" },
      { id:"t8_28", q:"___ 합니까? (때)",              answer:"언제",      answers:["언제"],                 hint:"💡 시간 의문대명사" },
      { id:"t8_29", q:"___ 왔습니까? (방법)",          answer:"어떻게",    answers:["어떻게"],               hint:"💡 방법 의문대명사" },
      { id:"t8_30", q:"이게 ___ 입니까? (값)",         answer:"얼마",      answers:["얼마"],                 hint:"💡 가격 의문대명사" },
      // ── 5단원: ~(으)세요 명령 (6문항) ──
      { id:"t8_31", q:"앉다 → ___",                   answer:"앉으세요",  answers:["앉으세요","앉으세요."], hint:"💡 받침 있음 → 으세요" },
      { id:"t8_32", q:"읽다 → ___",                   answer:"읽으세요",  answers:["읽으세요","읽으세요."], hint:"💡 받침 있음 → 읽으세요" },
      { id:"t8_33", q:"오다 → ___",                   answer:"오세요",    answers:["오세요","오세요."],     hint:"💡 받침 없음 → 세요" },
      { id:"t8_34", q:"먹다 → ___ (높임)",             answer:"드세요",    answers:["드세요","드세요."],     hint:"💡 먹다 높임말 → 드세요" },
      { id:"t8_35", q:"천천히 ___. (걷다)",            answer:"걸으세요",  answers:["걸으세요","걸으세요."], hint:"💡 걷다 → 걸으세요" },
      { id:"t8_36", q:"말하다 → ___",                  answer:"말하세요",  answers:["말하세요","말하세요."], hint:"💡 받침 없음 → 세요" },
      // ── 6단원: 연결어미 (8문항) ──
      { id:"t8_37", q:"비싸___ 좋습니다. (대조)",      answer:"지만",      answers:["지만"],                 hint:"💡 -지만 = but" },
      { id:"t8_38", q:"배가 고파___ 밥 먹습니다. (이유)", answer:"서",     answers:["서"],                   hint:"💡 이유 → 받침 없음 + 서" },
      { id:"t8_39", q:"한국어가 재미있___ 어렵습니다.", answer:"지만",      answers:["지만"],                 hint:"💡 -지만 = but" },
      { id:"t8_40", q:"비가 오___ 우산 있습니까? (배경)", answer:"는데",   answers:["는데"],                 hint:"💡 -는데 = 배경" },
      { id:"t8_41", q:"학교에 가___ 한국어를 배웁니다.", answer:"서",      answers:["서"],                   hint:"💡 이유·순서 → -아/어서" },
      { id:"t8_42", q:"밥을 먹___ 커피를 마십니다. (나열)", answer:"고",   answers:["고"],                   hint:"💡 나열 → -고" },
      { id:"t8_43", q:"날씨가 좋___ 산책합니다. (이유)", answer:"아서",    answers:["아서"],                 hint:"💡 좋다 + 아서 → 좋아서" },
      { id:"t8_44", q:"피곤하___ 일합니다. (대조)",    answer:"지만",      answers:["지만"],                 hint:"💡 -지만 = but" },
      // ── 7단원: 현재진행 -고 있다 (20문항) ──
      { id:"t8_45", q:"지금 밥 먹___ 있습니다.",       answer:"고",        answers:["고"],                   hint:"💡 동사 + 고 있다" },
      { id:"t8_46", q:"친구가 전화하___ 있습니다.",    answer:"고",        answers:["고"],                   hint:"💡 하다 계열 + 고" },
      { id:"t8_47", q:"아이가 자고 ___.",              answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 -고 있___" },
      { id:"t8_48", q:"저는 한국어 공부하___ 있습니다.", answer:"고",      answers:["고"],                   hint:"💡 공부하다 + 고" },
      { id:"t8_49", q:"엄마가 요리하고 ___.",          answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 -고 있___" },
      { id:"t8_50", q:"비가 오고 ___.",                answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 -고 있___" },
      { id:"t8_51", q:"지금 뭐 하___ 있습니까?",       answer:"고",        answers:["고"],                   hint:"💡 동사 + 고 있다" },
      { id:"t8_52", q:"동생이 음악 듣___ 있습니다.",   answer:"고",        answers:["고"],                   hint:"💡 듣다 + 고" },
      { id:"t8_53", q:"저는 지금 일하고 ___.",         answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 -고 있___" },
      { id:"t8_54", q:"친구가 공원에서 달리___ 있습니다.", answer:"고",    answers:["고"],                   hint:"💡 달리다 + 고" },
      { id:"t8_55", q:"선생님이 책을 읽___ 있습니다.", answer:"고",        answers:["고"],                   hint:"💡 읽다 + 고" },
      { id:"t8_56", q:"저는 지금 커피를 마시___ 있습니다.", answer:"고",   answers:["고"],                   hint:"💡 마시다 + 고" },
      { id:"t8_57", q:"아이들이 노래를 부르___ 있습니다.", answer:"고",    answers:["고"],                   hint:"💡 부르다 + 고" },
      { id:"t8_58", q:"지금 눈이 오___ 있습니다.",     answer:"고",        answers:["고"],                   hint:"💡 오다 + 고" },
      { id:"t8_59", q:"형이 지금 운동하___ 있습니다.", answer:"고",        answers:["고"],                   hint:"💡 운동하다 + 고" },
      { id:"t8_60", q:"저는 지금 한국어를 공부하고 ___.", answer:"있습니다", answers:["있습니다","있습니다."], hint:"💡 -고 있___" },
      { id:"t8_61", q:"친구가 밥을 먹고 ___.",         answer:"있습니다",  answers:["있습니다","있습니다."], hint:"💡 -고 있___" },
      { id:"t8_62", q:"선생님이 수업을 가르치___ 있습니다.", answer:"고",  answers:["고"],                   hint:"💡 가르치다 + 고" },
      { id:"t8_63", q:"지금 비가 오___ 있습니다.",     answer:"고",        answers:["고"],                   hint:"💡 오다 + 고" },
      { id:"t8_64", q:"저는 지금 영화를 보___ 있습니다.", answer:"고",     answers:["고"],                   hint:"💡 보다 + 고" },
      // ── 8단원: 청유 ~ㅂ시다/ㄹ까요/ㄹ래요 (14문항) ──
      { id:"t8_65", q:"같이 밥 먹___. (함께·격식)",    answer:"읍시다",    answers:["읍시다","읍시다."],     hint:"💡 먹다 → 받침+읍시다" },
      { id:"t8_66", q:"빨리 ___. (가자·격식)",          answer:"갑시다",    answers:["갑시다","갑시다."],     hint:"💡 가다 → ㅂ시다" },
      { id:"t8_67", q:"영화 볼___? (제안·의향)",        answer:"까요",      answers:["까요","까요?"],         hint:"💡 -(으)ㄹ까요?" },
      { id:"t8_68", q:"뭐 먹을___? (의향)",             answer:"까요",      answers:["까요","까요?"],         hint:"💡 먹다 → 먹을까요?" },
      { id:"t8_69", q:"같이 공부할___? (권유)",         answer:"래요",      answers:["래요","래요?"],         hint:"💡 -(으)ㄹ래요?" },
      { id:"t8_70", q:"커피 마실___? (권유)",           answer:"래요",      answers:["래요","래요?"],         hint:"💡 마시다 → 마실래요?" },
      { id:"t8_71", q:"같이 걸을___? (제안)",           answer:"까요",      answers:["까요","까요?"],         hint:"💡 걷다 → 걸을까요?" },
      { id:"t8_72", q:"내일 만날___? (의향)",           answer:"래요",      answers:["래요","래요?"],         hint:"💡 만나다 → 만날래요?" },
      { id:"t8_73", q:"함께 청소합___. (격식 청유)",    answer:"시다",      answers:["시다","시다."],         hint:"💡 하다 → 합시다" },
      { id:"t8_74", q:"도서관에서 공부합___. (격식 청유)", answer:"시다",   answers:["시다","시다."],         hint:"💡 합니다 → 합시다" },
      { id:"t8_75", q:"같이 운동할___? (권유)",         answer:"래요",      answers:["래요","래요?"],         hint:"💡 -(으)ㄹ래요?" },
      { id:"t8_76", q:"어디서 먹을___? (장소 제안)",    answer:"까요",      answers:["까요","까요?"],         hint:"💡 -(으)ㄹ까요?" },
      { id:"t8_77", q:"같이 여행 갑___. (격식 청유)",   answer:"시다",      answers:["시다","시다."],         hint:"💡 가다 → 갑시다" },
      { id:"t8_78", q:"뭘 마실___? (의향)",             answer:"래요",      answers:["래요","래요?"],         hint:"💡 -(으)ㄹ래요?" },
    ];
    function gradeTest8() {
      let ok=0;
  ...
  if (step === "test9") {
    ...
    const TEST9_Q = [
      // ── 1단원 복습 1문제 ──
      { id:"t9_1",  q:"오늘은 화요일___.",                       answer:"입니다",      answers:["입니다","입니다."],        hint:"💡 화요일 → 받침 있음 → 입니다" },
      // ── 2단원 복습 1문제 ──
      { id:"t9_2",  q:"지갑에 돈이 ___. (없음)",                answer:"없습니다",    answers:["없습니다","없습니다."],    hint:"💡 없다 → 없습니다" },
      // ── 3단원 복습 1문제 ──
      { id:"t9_3",  q:"이 음식이 ___. (맵다→ㅂ불규칙)",         answer:"맵습니다",    answers:["맵습니다","맵습니다."],    hint:"💡 맵다 → ㅂ불규칙 → 맵습니다" },
      // ── 4단원 복습 1문제 ──
      { id:"t9_4",  q:"___ 먹습니까? (사물 질문)",               answer:"무엇을",      answers:["무엇을","뭐"],             hint:"💡 사물 의문대명사" },
      // ── 5~6단원 복습 1문제 ──
      { id:"t9_5",  q:"한국어가 재미있___ 어렵습니다. (역접)",   answer:"지만",        answers:["지만"],                    hint:"💡 -지만 = but" },
      // ── 7단원 복습 1문제 ──
      { id:"t9_6",  q:"엄마가 요리하고 ___. (진행)",             answer:"있습니다",    answers:["있습니다","있습니다."],    hint:"💡 -고 있다 → 있습니다" },
      // ── 8단원 복습 1문제 ──
      { id:"t9_7",  q:"커피 마실___? (권유)",                    answer:"래요",        answers:["래요","래요?"],            hint:"💡 -(으)ㄹ래요?" },
      // ── 9단원 3문제 ──
      { id:"t9_8",  q:"저는 한국어를 말할 ___ ___. (가능)",      answer:"수 있습니다", answers:["수 있습니다","수 있습니다."],hint:"💡 -(으)ㄹ 수 있다 → 있습니다" },
      { id:"t9_9",  q:"저는 수영을 할 ___ ___. (불가능)",        answer:"수 없습니다", answers:["수 없습니다","수 없습니다."],hint:"💡 -(으)ㄹ 수 없다 → 없습니다" },
      { id:"t9_10", q:"오늘 만날 ___ ___? (가능 여부)",          answer:"수 있습니까", answers:["수 있습니까","수 있습니까?"],hint:"💡 만나다 → 만날 수 있습니까?" },
    ];
    function gradeTest9() {
      let ok=0;
  ...
  if (step === "test10") {
    ...
    const TEST10_Q = [
      // ── 1단원 복습 1문제 ──
      { id:"t10_1",  q:"이분은 교장 선생님___. (높임)",          answer:"이세요",    answers:["이세요","이세요."],       hint:"💡 높임말 → 이세요" },
      // ── 2단원 복습 1문제 ──
      { id:"t10_2",  q:"은행 옆에 편의점이 ___. (위치)",         answer:"있습니다",  answers:["있습니다","있습니다."],   hint:"💡 있다 → 있습니다" },
      // ── 3단원 복습 1문제 ──
      { id:"t10_3",  q:"이 짐이 ___. (무겁다→ㅂ불규칙)",        answer:"무겁습니다",answers:["무겁습니다","무겁습니다."],hint:"💡 무겁다 → 무겁습니다" },
      // ── 4~6단원 복습 2문제 ──
      { id:"t10_4",  q:"___ 갑니까? (시간 질문)",                answer:"언제",      answers:["언제"],                   hint:"💡 시간 의문대명사" },
      { id:"t10_5",  q:"비가 오___ 바람이 붑니다. (and)",        answer:"고",        answers:["고"],                     hint:"💡 -고 = and" },
      // ── 7~8단원 복습 1문제 ──
      { id:"t10_6",  q:"친구가 전화하고 ___. (진행)",            answer:"있습니다",  answers:["있습니다","있습니다."],   hint:"💡 -고 있다 → 있습니다" },
      // ── 9단원 복습 1문제 ──
      { id:"t10_7",  q:"저는 피아노를 칠 ___ ___. (가능)",       answer:"수 있습니다",answers:["수 있습니다","수 있습니다."],hint:"💡 치다 → 칠 수 있습니다" },
      // ── 10단원 3문제 ──
      { id:"t10_8",  q:"저는 한국에 가고 ___. (희망)",           answer:"싶습니다",  answers:["싶습니다","싶습니다."],   hint:"💡 -고 싶다 → 싶습니다" },
      { id:"t10_9",  q:"무엇을 먹고 ___? (의향)",                answer:"싶습니까",  answers:["싶습니까","싶습니까?"],   hint:"💡 먹다+고 싶다 → 싶습니까?" },
      { id:"t10_10", q:"저는 쉬고 ___. (희망)",                   answer:"싶습니다",  answers:["싶습니다","싶습니다."],   hint:"💡 쉬다+고 싶다 → 싶습니다" },
    ];
  ...
  if (step === "test11") {
    ...
    const TEST11_Q = [
      // ── 1단원 복습 1문제 ──
      { id:"t11_1",  q:"저는 베트남 사람___.",                    answer:"입니다",      answers:["입니다","입니다."],          hint:"💡 받침 있음 → 입니다" },
      // ── 2~3단원 복습 1문제 ──
      { id:"t11_2",  q:"한국어가 ___. (어렵다→ㅂ불규칙)",        answer:"어렵습니다",  answers:["어렵습니다","어렵습니다."],  hint:"💡 어렵다 → 어렵습니다" },
      // ── 4~5단원 복습 1문제 ──
      { id:"t11_3",  q:"___ (읽다 → 부드러운 명령)",              answer:"읽으세요",    answers:["읽으세요","읽으세요."],      hint:"💡 읽다 → 읽으세요" },
      // ── 6~7단원 복습 1문제 ──
      { id:"t11_4",  q:"지금 아이가 자고 ___. (진행)",            answer:"있습니다",    answers:["있습니다","있습니다."],      hint:"💡 -고 있다 → 있습니다" },
      // ── 8~9단원 복습 2문제 ──
      { id:"t11_5",  q:"빨리 ___. (함께 가자·격식)",              answer:"갑시다",      answers:["갑시다","갑시다."],          hint:"💡 가다+ㅂ시다" },
      { id:"t11_6",  q:"저는 운전을 할 ___ ___. (불가능)",        answer:"수 없습니다", answers:["수 없습니다","수 없습니다."],hint:"💡 -(으)ㄹ 수 없다 → 없습니다" },
      // ── 10단원 복습 1문제 ──
      { id:"t11_7",  q:"저는 한국어를 잘하고 ___. (희망)",        answer:"싶습니다",    answers:["싶습니다","싶습니다."],      hint:"💡 -고 싶다 → 싶습니다" },
      // ── 11단원 3문제 ──
      { id:"t11_8",  q:"날씨가 좋___으면 좋겠습니다. (희망)",     answer:"았",          answers:["았"],                       hint:"💡 좋다(아계열) → 았으면" },
      { id:"t11_9",  q:"걱정이 없___으면 좋겠습니다. (희망)",     answer:"었",          answers:["었"],                       hint:"💡 없다(어계열) → 었으면" },
      { id:"t11_10", q:"건강___으면 좋겠습니다. (희망)",           answer:"했",          answers:["했"],                       hint:"💡 건강하다 → 했으면" },
    ];
  ...
  if (step === "test12") {
    ...
    const TEST12_Q = [
      // ── 1~2단원 복습 1문제 ──
      { id:"t12_1",  q:"냉장고에 음식이 ___. (있음)",              answer:"있습니다",    answers:["있습니다","있습니다."],      hint:"💡 있다 → 있습니다" },
      // ── 3단원 복습 1문제 ──
      { id:"t12_2",  q:"날씨가 ___. (좋다)",                       answer:"좋습니다",    answers:["좋습니다","좋습니다."],      hint:"💡 좋다 → 좋습니다" },
      // ── 4~6단원 복습 1문제 ──
      { id:"t12_3",  q:"저는 커피를 좋아합니다. ___ 차도 좋아합니다. (and)", answer:"그리고", answers:["그리고"],               hint:"💡 그리고 = and" },
      // ── 7~8단원 복습 1문제 ──
      { id:"t12_4",  q:"같이 공부할___? (함께 하자·권유)",          answer:"래요",        answers:["래요","래요?"],              hint:"💡 -(으)ㄹ래요?" },
      // ── 9단원 복습 1문제 ──
      { id:"t12_5",  q:"이 음식을 먹을 ___ ___? (가능 여부)",       answer:"수 있습니까", answers:["수 있습니까","수 있습니까?"],hint:"💡 먹다 → 먹을 수 있습니까?" },
      // ── 10~11단원 복습 2문제 ──
      { id:"t12_6",  q:"저는 쉬고 ___. (희망)",                     answer:"싶습니다",    answers:["싶습니다","싶습니다."],      hint:"💡 -고 싶다 → 싶습니다" },
      { id:"t12_7",  q:"돈이 많___으면 좋겠습니다. (희망)",          answer:"았",          answers:["았"],                       hint:"💡 많다(아계열) → 았으면" },
      // ── 12단원 3문제 ──
      { id:"t12_8",  q:"저는 오늘 밥을 ___ 먹습니다. (의지 부정)",  answer:"안",          answers:["안"],                       hint:"💡 안 + 동사 = 의지로 안 함" },
      { id:"t12_9",  q:"저는 고기를 먹지 ___. (정중 부정)",          answer:"않습니다",    answers:["않습니다","않습니다."],      hint:"💡 -지 않다 → 않습니다" },
      { id:"t12_10", q:"여기서 사진을 찍지 ___. (금지 명령)",        answer:"마세요",      answers:["마세요","마세요."],          hint:"💡 -지 마세요 (세요 유지)" },
    ];
  ...
  if (step === "test13") {
    ...
    const TEST13_Q = [
      // ── 1단원 복습 1문제 ──
      { id:"t13_1",  q:"저는 회사원___.",                           answer:"입니다",      answers:["입니다","입니다."],          hint:"💡 받침 있음 → 입니다" },
      // ── 2~3단원 복습 1문제 ──
      { id:"t13_2",  q:"이 가방이 ___. (가볍다→ㅂ불규칙)",          answer:"가볍습니다",  answers:["가볍습니다","가볍습니다."],  hint:"💡 가볍다 → 가볍습니다" },
      // ── 5~6단원 복습 1문제 ──
      { id:"t13_3",  q:"저는 커피를 좋아합니다. ___ 매운 건 못 먹습니다. (역접)", answer:"하지만", answers:["하지만"],          hint:"💡 하지만 = but" },
      // ── 7~8단원 복습 1문제 ──
      { id:"t13_4",  q:"지금 비가 오고 ___. (진행)",                answer:"있습니다",    answers:["있습니다","있습니다."],      hint:"💡 -고 있다 → 있습니다" },
      // ── 9단원 복습 1문제 ──
      { id:"t13_5",  q:"저는 한국어를 말할 ___ ___. (가능)",        answer:"수 있습니다", answers:["수 있습니다","수 있습니다."],hint:"💡 -(으)ㄹ 수 있다 → 있습니다" },
      // ── 10~11단원 복습 1문제 ──
      { id:"t13_6",  q:"빨리 방학이 ___으면 좋겠습니다. (희망)",    answer:"됐",          answers:["됐"],                       hint:"💡 되다 → 됐으면 좋겠다" },
      // ── 12단원 복습 1문제 ──
      { id:"t13_7",  q:"교실에서 떠들지 ___. (함께 금지)",          answer:"맙시다",      answers:["맙시다","맙시다."],          hint:"💡 -지 맙시다" },
      // ── 13단원 3문제 ──
      { id:"t13_8",  q:"여기서 사진을 찍어도 ___? (허락 질문)",     answer:"됩니까",      answers:["됩니까","됩니까?"],          hint:"💡 -아/어도 됩니까?" },
      { id:"t13_9",  q:"아니요, 찍으면 ___ ___. (금지)",            answer:"안 됩니다",   answers:["안 됩니다","안 됩니다."],    hint:"💡 -(으)면 안 됩니다" },
      { id:"t13_10", q:"조용히 해야 ___. (의무)",                    answer:"합니다",      answers:["합니다","합니다."],          hint:"💡 -아/어야 합니다" },
    ];
